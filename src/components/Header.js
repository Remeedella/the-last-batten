        ...
        <div className="container-fluid pt-3 pb-3">
          <div className="w-100">
            <div className="d-flex d-md-none">
              <div style={{width: '40%'}}>
              <Link to="/">
                <StaticImage src="../images/logo.png" className="img-fluid ps-2 position-relative" style={{maxHeight: '180px', top: '8px'}} />
                </Link>
              </div>
              <div className="align-self-end text-nowrap py-1 ps-1 d-inline-block" style={{width: '60%'}}>
                <div className="slogan-xs"> 
            ...
            <div className="d-none d-lg-flex d-xxl-one">
              ...
              <nav className="align-items-end bg-white d-lg-flex d-none ms-auto navbar navbar-light" style={{width: '20%', paddingBottom: '25px', maxWidth: '300px'}}>
                <div className="container" style={{maxWidth: '285px', minWidth: '154px'}}>
                  <StaticImage src="../images/instagram-ic.svg" className="lg-icon" />
                  <StaticImage src="../images/facebook-ic.svg" className="lg-icon" style={{maxHeight: '35px'}} />
                  <StaticImage src="../images/youtube-ic.svg" className="lg-icon" style={{maxHeight: '35px'}} />
                  <StaticImage src="../images/fiverr-ic.svg" className="lg-icon" style={{paddingTop: '3px'}} />
                  <div className="collapse navbar-collapse" id="navbarsExampleDefault">
                    <ul className="navbar-nav me-auto mb-2 mb-md-0">
                      <li className="nav-item active">
                      <Link to="/about/" className="nav-link" aria-current="page">about me</Link>
